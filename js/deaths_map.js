  ...
  .then(responseArrs => {
    ...
    african_data.eachLayer(function (layer) {
      ...
      layer.bindPopup(
        ...
        + '<br>' + '<strong>Deaths:</strong> ' + icus_obj[country_][1]
        + '<br>' + '<strong>Deaths per 100,000 people:</strong> ' + icus_obj[country_][2]
      );
    ...
    function styledeaths(feature) {
      return {
        fillColor: getColordeaths(parseFloat(icus_obj[feature.properties.COUNTRY][2].split(",").join(""))),
        weight: 1,
        opacity: 1,
        color: 'black',
        dashArray: '0',
