  ...
  .then(responseArrs => {
    ...
    african_data.eachLayer(function (layer) {
      ...
      layer.bindPopup(
        ...
        + '<br>' + '<strong>HIV rates:</strong> ' + icus_obj[country_][1]
        + '<br>' + '<strong>HIV percentage:</strong> ' + icus_obj[country_][2]
      );
    ...
    function styleHIV(feature) {
      return {
        fillColor: getColorHIV(parseFloat(icus_obj[feature.properties.COUNTRY][2].split(",").join(""))),
        weight: 1,
        opacity: 1,
        color: 'black',
        dashArray: '0',
